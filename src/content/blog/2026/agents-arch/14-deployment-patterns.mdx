...
<svg viewBox="0 0 760 320" xmlns="http://www.w3.org/2000/svg" class="mx-auto block" style="max-width:100%;height:auto" role="img" aria-label="Three agent deployment shapes">
  <g fill="none" stroke="currentColor" stroke-width="1.5" font-family="ui-monospace, Menlo, monospace" font-size="12">
    <rect x="30" y="30" width="220" height="240" rx="8" />
    <text x="140" y="55" text-anchor="middle" font-weight="700">Request / response</text>
    <text x="140" y="80" text-anchor="middle" opacity="0.7">latency-sensitive chat</text>
    <text x="140" y="115" text-anchor="middle">Cloud Run</text>
    <text x="140" y="135" text-anchor="middle">Lambda / Functions</text>
    <text x="140" y="155" text-anchor="middle">Fargate / k8s</text>
    <text x="140" y="195" text-anchor="middle" opacity="0.8">no checkpoint</text>
    <text x="140" y="215" text-anchor="middle" opacity="0.8">tight timeouts</text>
    <text x="140" y="235" text-anchor="middle" opacity="0.8">autoscales on RPS</text>

    <rect x="270" y="30" width="220" height="240" rx="8" />
    <text x="380" y="55" text-anchor="middle" font-weight="700">Long-running stateful</text>
    <text x="380" y="80" text-anchor="middle" opacity="0.7">multi-step / HITL</text>
    <text x="380" y="115" text-anchor="middle">Managed runtimes</text>
    <text x="380" y="135" text-anchor="middle">k8s with PVCs</text>
    <text x="380" y="155" text-anchor="middle">VMs + checkpointer</text>
    <text x="380" y="195" text-anchor="middle" opacity="0.8">durable session state</text>
    <text x="380" y="215" text-anchor="middle" opacity="0.8">resume after restart</text>
    <text x="380" y="235" text-anchor="middle" opacity="0.8">scales on session count</text>

    <rect x="510" y="30" width="220" height="240" rx="8" />
    <text x="620" y="55" text-anchor="middle" font-weight="700">Background batch</text>
    <text x="620" y="80" text-anchor="middle" opacity="0.7">async, queue-driven</text>
    <text x="620" y="115" text-anchor="middle">Queue worker pool</text>
    <text x="620" y="135" text-anchor="middle">SQS / Pub/Sub / NATS</text>
    <text x="620" y="155" text-anchor="middle">Step Functions / DAGs</text>
    <text x="620" y="195" text-anchor="middle" opacity="0.8">at-least-once delivery</text>
    <text x="620" y="215" text-anchor="middle" opacity="0.8">retries + DLQ</text>
    <text x="620" y="235" text-anchor="middle" opacity="0.8">scales on queue depth</text>
  </g>
</svg>
</div>
