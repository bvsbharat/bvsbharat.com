...
<svg viewBox="0 0 760 320" xmlns="http://www.w3.org/2000/svg" class="mx-auto block" style="max-width:100%;height:auto" role="img" aria-label="DIY vs managed agent platform">
  <g fill="none" stroke="currentColor" stroke-width="1.5" font-family="ui-monospace, Menlo, monospace" font-size="12">
    <text x="190" y="20" text-anchor="middle" font-weight="700">DIY agent platform</text>
    <rect x="40" y="35" width="300" height="40" rx="6" />
    <text x="190" y="60" text-anchor="middle">Your agent loop (LangGraph / ADK / custom)</text>
    <rect x="40" y="85" width="300" height="40" rx="6" />
    <text x="190" y="110" text-anchor="middle">Tool execution sandbox</text>
    <rect x="40" y="135" width="300" height="40" rx="6" />
    <text x="190" y="160" text-anchor="middle">Session state (Postgres / Redis)</text>
    <rect x="40" y="185" width="300" height="40" rx="6" />
    <text x="190" y="210" text-anchor="middle">Credential vault + IAM</text>
    <rect x="40" y="235" width="300" height="40" rx="6" />
    <text x="190" y="260" text-anchor="middle">Container orchestration (k8s / ECS)</text>
    <rect x="40" y="285" width="300" height="25" rx="6" />
    <text x="190" y="302" text-anchor="middle" opacity="0.8">Observability + autoscale</text>

    <text x="570" y="20" text-anchor="middle" font-weight="700">Managed (Claude / AgentCore)</text>
    <rect x="420" y="35" width="300" height="40" rx="6" />
    <text x="570" y="60" text-anchor="middle">Your agent loop (your code)</text>
    <rect x="420" y="85" width="300" height="190" rx="6" stroke-dasharray="3,3" />
    <text x="570" y="115" text-anchor="middle" font-weight="600">Managed runtime</text>
    <text x="570" y="138" text-anchor="middle" opacity="0.8">sandboxed exec</text>
    <text x="570" y="158" text-anchor="middle" opacity="0.8">durable sessions</text>
    <text x="570" y="178" text-anchor="middle" opacity="0.8">scoped credentials</text>
    <text x="570" y="198" text-anchor="middle" opacity="0.8">container scheduling</text>
    <text x="570" y="218" text-anchor="middle" opacity="0.8">autoscale</text>
    <text x="570" y="238" text-anchor="middle" opacity="0.8">observability hooks</text>
    <rect x="420" y="285" width="300" height="25" rx="6" />
    <text x="570" y="302" text-anchor="middle" opacity="0.8">Per-session billing</text>
  </g>
</svg>
</div>
