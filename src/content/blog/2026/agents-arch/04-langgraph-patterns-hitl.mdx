...
featured: false
draft: false
heroImage: "/images/agents-arch/04-langgraph-patterns-hero.svg"
ogImage: "/images/agents-arch/04-langgraph-patterns-hero.svg"
---
...
<svg viewBox="0 0 900 480" xmlns="http://www.w3.org/2000/svg" class="mx-auto block" style="max-width:100%;height:auto;font-family:Inter,system-ui,sans-serif" role="img" aria-label="LangGraph patterns: cycle, fan-out, HITL">
  <defs>
    <marker id="a4" markerWidth="12" markerHeight="12" refX="11" refY="6" orient="auto"><path d="M0,0 L12,6 L0,12 z" fill="#475569"/></marker>
  </defs>

  <ellipse cx="55" cy="70" rx="42" ry="28" fill="#FEF3C7" stroke="#F59E0B" stroke-width="2.5"/>
  <text x="55" y="76" text-anchor="middle" fill="#78350F" font-weight="700" font-size="14">START</text>

  <rect x="135" y="40" width="150" height="60" rx="10" fill="#D1FAE5" stroke="#10B981" stroke-width="2.5"/>
  <text x="210" y="76" text-anchor="middle" fill="#064E3B" font-weight="700" font-size="15">plan</text>

  <polygon points="325,70 395,30 465,70 395,110" fill="#FEE2E2" stroke="#EF4444" stroke-width="2.5"/>
  <text x="395" y="76" text-anchor="middle" fill="#7F1D1D" font-weight="700" font-size="14">route</text>

  <rect x="500" y="40" width="150" height="60" rx="10" fill="#CFFAFE" stroke="#06B6D4" stroke-width="2.5"/>
  <text x="575" y="76" text-anchor="middle" fill="#164E63" font-weight="700" font-size="15">call_tool</text>

  <rect x="690" y="40" width="150" height="60" rx="10" fill="#EDE9FE" stroke="#8B5CF6" stroke-width="2.5"/>
  <text x="765" y="68" text-anchor="middle" fill="#4C1D95" font-weight="700" font-size="14">force_finish</text>
  <text x="765" y="88" text-anchor="middle" fill="#5B21B6" font-size="11">budget cap</text>

  <text x="450" y="170" text-anchor="middle" fill="#475569" font-weight="600" font-size="13" font-style="italic">— parallel fan-out (Send API) —</text>

  <rect x="160" y="190" width="150" height="60" rx="10" fill="#FCE7F3" stroke="#EC4899" stroke-width="2.5"/>
  <text x="235" y="226" text-anchor="middle" fill="#831843" font-weight="700" font-size="15">summarize₁</text>

  <rect x="335" y="190" width="150" height="60" rx="10" fill="#FCE7F3" stroke="#EC4899" stroke-width="2.5"/>
  <text x="410" y="226" text-anchor="middle" fill="#831843" font-weight="700" font-size="15">summarize₂</text>

  <rect x="510" y="190" width="150" height="60" rx="10" fill="#FCE7F3" stroke="#EC4899" stroke-width="2.5"/>
  <text x="585" y="226" text-anchor="middle" fill="#831843" font-weight="700" font-size="15">summarize₃</text>

  <rect x="335" y="290" width="200" height="60" rx="10" fill="#FEF3C7" stroke="#F59E0B" stroke-width="2.5"/>
  <text x="435" y="326" text-anchor="middle" fill="#78350F" font-weight="700" font-size="15">aggregate (fan-in)</text>

  <rect x="160" y="390" width="220" height="68" rx="10" fill="#FEE2E2" stroke="#EF4444" stroke-width="2.5" stroke-dasharray="6,4"/>
  <text x="270" y="420" text-anchor="middle" fill="#7F1D1D" font-weight="700" font-size="15">propose_action</text>
  <text x="270" y="441" text-anchor="middle" fill="#991B1B" font-size="12">interrupt → human approval</text>

  <rect x="440" y="390" width="170" height="68" rx="10" fill="#D1FAE5" stroke="#10B981" stroke-width="2.5"/>
  <text x="525" y="420" text-anchor="middle" fill="#064E3B" font-weight="700" font-size="15">execute</text>
  <text x="525" y="441" text-anchor="middle" fill="#065F46" font-size="12">if approved</text>

  <ellipse cx="780" cy="424" rx="50" ry="32" fill="#DBEAFE" stroke="#3B82F6" stroke-width="2.5"/>
  <text x="780" y="430" text-anchor="middle" fill="#1E3A8A" font-weight="700" font-size="15">END</text>

  <g stroke="#475569" stroke-width="2.5" fill="none">
    <line x1="97" y1="70" x2="130" y2="70" marker-end="url(#a4)"/>
    <line x1="285" y1="70" x2="320" y2="70" marker-end="url(#a4)"/>
    <line x1="465" y1="70" x2="495" y2="70" marker-end="url(#a4)"/>
    <line x1="650" y1="70" x2="685" y2="70" marker-end="url(#a4)"/>
    <path d="M575 100 Q575 130 210 130 L210 95" marker-end="url(#a4)" stroke-dasharray="4,4"/>
    <line x1="395" y1="110" x2="235" y2="185" marker-end="url(#a4)"/>
    <line x1="395" y1="110" x2="410" y2="185" marker-end="url(#a4)"/>
    <line x1="395" y1="110" x2="585" y2="185" marker-end="url(#a4)"/>
    <line x1="235" y1="250" x2="395" y2="285" marker-end="url(#a4)"/>
    <line x1="410" y1="250" x2="435" y2="285" marker-end="url(#a4)"/>
    <line x1="585" y1="250" x2="475" y2="285" marker-end="url(#a4)"/>
    <line x1="435" y1="350" x2="280" y2="385" marker-end="url(#a4)"/>
    <line x1="380" y1="424" x2="435" y2="424" marker-end="url(#a4)"/>
    <line x1="610" y1="424" x2="730" y2="424" marker-end="url(#a4)"/>
    <path d="M765 100 Q840 200 800 392" marker-end="url(#a4)" stroke-dasharray="4,4"/>
  </g>
</svg>
</div>
