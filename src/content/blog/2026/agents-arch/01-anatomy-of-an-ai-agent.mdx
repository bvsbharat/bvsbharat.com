...
featured: false
draft: false
heroImage: "/images/agents-arch/01-anatomy-hero.svg"
ogImage: "/images/agents-arch/01-anatomy-hero.svg"
---
...
<svg viewBox="0 0 900 460" xmlns="http://www.w3.org/2000/svg" class="mx-auto block" style="max-width:100%;height:auto;font-family:Inter,system-ui,sans-serif" role="img" aria-label="AI agent reference architecture">
  <defs>
    <marker id="a1" markerWidth="12" markerHeight="12" refX="11" refY="6" orient="auto"><path d="M0,0 L12,6 L0,12 z" fill="#475569"/></marker>
  </defs>
  <rect x="40" y="40" width="200" height="90" rx="10" fill="#DBEAFE" stroke="#3B82F6" stroke-width="2"/>
  <text x="140" y="75" text-anchor="middle" fill="#1E3A8A" font-weight="700" font-size="16">User / Trigger</text>
  <text x="140" y="98" text-anchor="middle" fill="#1E40AF" font-size="13">HTTP · cron · webhook</text>
  <text x="140" y="116" text-anchor="middle" fill="#1E40AF" font-size="13">event bus</text>

  <rect x="350" y="40" width="200" height="90" rx="10" fill="#D1FAE5" stroke="#10B981" stroke-width="2"/>
  <text x="450" y="75" text-anchor="middle" fill="#064E3B" font-weight="700" font-size="16">Reasoning Loop</text>
  <text x="450" y="98" text-anchor="middle" fill="#065F46" font-size="13">plan → act → observe</text>
  <text x="450" y="116" text-anchor="middle" fill="#065F46" font-size="13">step budget · stop check</text>

  <rect x="660" y="40" width="200" height="90" rx="10" fill="#EDE9FE" stroke="#8B5CF6" stroke-width="2"/>
  <text x="760" y="75" text-anchor="middle" fill="#4C1D95" font-weight="700" font-size="16">LLM Provider</text>
  <text x="760" y="98" text-anchor="middle" fill="#5B21B6" font-size="13">Claude · GPT · Gemini</text>
  <text x="760" y="116" text-anchor="middle" fill="#5B21B6" font-size="13">function calling</text>

  <rect x="40" y="200" width="200" height="90" rx="10" fill="#FEF3C7" stroke="#F59E0B" stroke-width="2"/>
  <text x="140" y="235" text-anchor="middle" fill="#78350F" font-weight="700" font-size="16">Memory</text>
  <text x="140" y="258" text-anchor="middle" fill="#92400E" font-size="13">working · session</text>
  <text x="140" y="276" text-anchor="middle" fill="#92400E" font-size="13">long-term · episodic</text>

  <rect x="350" y="200" width="200" height="90" rx="10" fill="#FEE2E2" stroke="#EF4444" stroke-width="2"/>
  <text x="450" y="235" text-anchor="middle" fill="#7F1D1D" font-weight="700" font-size="16">Control Plane</text>
  <text x="450" y="258" text-anchor="middle" fill="#991B1B" font-size="13">policy · budget</text>
  <text x="450" y="276" text-anchor="middle" fill="#991B1B" font-size="13">HITL · stop</text>

  <rect x="660" y="200" width="200" height="90" rx="10" fill="#CFFAFE" stroke="#06B6D4" stroke-width="2"/>
  <text x="760" y="235" text-anchor="middle" fill="#164E63" font-weight="700" font-size="16">Tool Layer</text>
  <text x="760" y="258" text-anchor="middle" fill="#155E75" font-size="13">APIs · DB · MCP</text>
  <text x="760" y="276" text-anchor="middle" fill="#155E75" font-size="13">scoped tool sets</text>

  <rect x="200" y="360" width="500" height="70" rx="10" fill="#F1F5F9" stroke="#475569" stroke-width="2" stroke-dasharray="6,4"/>
  <text x="450" y="392" text-anchor="middle" fill="#0F172A" font-weight="700" font-size="16">Observability · Tracing · Eval</text>
  <text x="450" y="413" text-anchor="middle" fill="#334155" font-size="13">LangSmith · Langfuse · OpenTelemetry</text>

  <g stroke="#475569" stroke-width="2.5" fill="none">
    <line x1="240" y1="85" x2="345" y2="85" marker-end="url(#a1)"/>
    <line x1="550" y1="85" x2="655" y2="85" marker-end="url(#a1)"/>
    <line x1="450" y1="130" x2="450" y2="195" marker-end="url(#a1)"/>
    <line x1="240" y1="245" x2="345" y2="245" marker-end="url(#a1)"/>
    <line x1="550" y1="245" x2="655" y2="245" marker-end="url(#a1)"/>
    <line x1="450" y1="290" x2="450" y2="355" stroke-dasharray="4,4" marker-end="url(#a1)"/>
  </g>
</svg>
</div>
